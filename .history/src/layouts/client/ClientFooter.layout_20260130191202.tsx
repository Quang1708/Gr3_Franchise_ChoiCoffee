      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-white/60 text-sm">
            <li><a className="hover:text-primary transition-colors" href="#">Về ChoiCoffee</a></li>
            <li><a className="hover:text-primary transition-colors" href="#">Mô hình cửa hàng</a></li>
            <li><a className="hover:text-primary transition-colors" href="#">Vùng nguyên liệu</a></li>
            <li><a className="hover:text-primary transition-colors" href="#">Quy trình vận hành</a></li>
          </ul>
        </div>
      </div>
    </footer>
