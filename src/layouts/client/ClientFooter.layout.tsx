const ClientFooter = () => {
  return (
    <footer className="bg-espresso text-white py-10 sm:py-14 lg:py-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
        <div className="md:col-span-2">
          ...
          <p className="text-white/60 max-w-md mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
