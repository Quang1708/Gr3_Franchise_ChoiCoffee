...
const ClientHeader = () => {
  ...
  const handleFranchiseSelect = (franchiseId: number) => {
    ...
    setTimeout(() => {
      ...
      window.dispatchEvent(new CustomEvent("franchiseChanged", { 
        detail: { franchiseId } 
      }));
          ...
          <nav className="flex flex-col py-2">
            ...
            <div className="px-6 py-3 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">Chọn chi nhánh</span>
              </div>
              <div className="relative" ref={franchiseDropdownRef}>
                <button
                  title="franchise" 
