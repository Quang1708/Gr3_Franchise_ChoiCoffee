    ...
    <div>
      <section className="relative w-full overflow-hidden">
        <div className="max-w mx-auto px-4 sm:px-6 lg:px-40 py-8">
          <div
            className="relative rounded-2xl overflow-hidden min-h-150 flex items-center bg-cover bg-center"
            data-alt="Interior of a modern ChoiCoffee shop with warm lighting and wooden furniture"
            style={{
              backgroundImage:
                "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('https://lh3.googleusercontent.com/aida-public/AB6AXuATRRv2ZVajSaGD94NFN2QVtxBuEUc58-hn9bXRn5Ni_2E6sNaeXmI20wRKsopabiRZ0EYu8FdfXlRw_ezrPtr_7Be_iQ0SA0uYXAOV6S9B2GjK6R1af7muXnAVH1CPfcj81HIRa48bWl02CsEcS2ZQVaFEX1nkrVGMoED33cbbWRNXSfPGMGb7qiHGEBl40ikPr0dbjB7oDrihvPsgei4_-tYH9rMhGD0bIiPRqL5BvaF_gKwTmJzjPqBpShcXx49jzfv9rnd9KErT')",
            }}
          >
            <div className="p-8 md:p-16 max-w-2xl">
              ...
              <p className="text-gray-200 text-lg md:text-xl font-medium mb-8 leading-relaxed">
                Khởi nghiệp kinh doanh cà phê chuyên nghiệp với chuỗi cung ứng
                khép kín và hỗ trợ marketing toàn diện từ thương hiệu hàng đầu.
              </p>
      ...
      <section className="py-20 bg-white dark:bg-background-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-40">
          <div className="mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-charcoal dark:text-white">
              Tại Sao Chọn ChoiCoffee?
            </h2>
            <p className="mt-4 text-gray-500 max-w-2xl text-lg">
              Chúng tôi mang đến giải pháp kinh doanh tối ưu, giúp đối tác tối
              thiểu hóa rủi ro và tối đa hóa lợi nhuận bền vững.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl border border-gray-100 dark:border-gray-800 bg-background-light dark:bg-zinc-900 transition-all hover:shadow-xl hover:-translate-y-1">
              ...
              <p className="text-gray-500 leading-relaxed">
                Nền tảng thương hiệu vững chắc với hàng ngàn khách hàng trung
                thành và độ nhận diện cao trên thị trường.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-gray-100 dark:border-gray-800 bg-background-light dark:bg-zinc-900 transition-all hover:shadow-xl hover:-translate-y-1">
              ...
              <h4 className="text-xl font-bold mb-3">
                Chuỗi Cung Ứng Farm-to-Cup
              </h4>
              <p className="text-gray-500 leading-relaxed">
                Kiểm soát chất lượng hạt cà phê tuyệt đối từ nông trường tại Đắk
                Lắk đến tận tay người tiêu dùng.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-gray-100 dark:border-gray-800 bg-background-light dark:bg-zinc-900 transition-all hover:shadow-xl hover:-translate-y-1">
              ...
              <p className="text-gray-500 leading-relaxed">
                Đồng hành cùng đối tác trong các chiến dịch truyền thông đa kênh
        ...
        <div className="max-w mx-auto px-4 sm:px-6 lg:px-40">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-500 max-w-xl mx-auto">
              Lựa chọn mô hình phù hợp với ngân sách và vị trí kinh doanh của
              bạn.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8 flex flex-col h-full relative overflow-hidden group">
              ...
              <p className="text-gray-500 mb-8 font-medium">
                Lựa chọn tối ưu cho mặt bằng vỉa hè, tòa nhà văn phòng hoặc
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8 flex flex-col h-full relative overflow-hidden group">
              ...
              <p className="text-gray-500 mb-8 font-medium">
                Không gian trải nghiệm đẳng cấp dành cho khách hàng thưởng thức
                tại chỗ.
              </p>
              <ul className="space-y-4 mb-10 grow">
                <li className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-500 mb-8">
                Để lại thông tin, đội ngũ tư vấn của ChoiCoffee sẽ liên hệ với
                bạn trong vòng 24h để trao đổi chi tiết về cơ hội kinh doanh.
              </p>
            ...
            <div className="flex-1 w-full max-w-lg bg-background-light dark:bg-zinc-900 p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-xl">
              <form className="space-y-5">
                ...
                <button className="w-full bg-primary hover:bg-primary/90 text-white font-black py-4 rounded-xl shadow-lg transition-all mt-4 uppercase tracking-wider cursor-pointer">
                  Đăng Ký Tư Vấn
                </button>
                <p className="text-center text-xs text-gray-400 mt-4">
                  Bằng cách nhấp vào đăng ký, bạn đồng ý với các Điều khoản bảo
                  mật của chúng tôi.
                </p>
              </form>
            </div>
