...
import { setAdminToken, setItemInLocalStorage } from "../../../../utils/localStorage.util";
...
const AdminLoginPage: React.FC = () => {
  const [form, setForm] = useState<AdminAuthSchemaType>({
    email: "",
    password: "",
  });
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (foundUser && foundUser.role === "admin") {
      // 1) lưu user + token trước (chuẩn flow)
