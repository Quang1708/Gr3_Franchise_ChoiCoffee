    ...
    const initForm = async () => {
      try {
        if (isAdmin) {
          ...
          setFranchiseOptions([
            { label: "Chi nhánh hiện tại", value: selectedFranchiseId },
          ]);
        }
        if (mode === "create") {
          reset({
          ...
          {isAdmin && (
            <div className="space-y-1.5">
                ...
                <div className="py-2">
                  <span className="text-base font-semibold text-gray-700">
                    {franchiseOptions.find(
                      (opt) => opt.value === getValues("franchise_id"),
              ...
              <p className="text-primary text-xs mt-1">
                Vui lòng chọn chi nhánh để tạo hạng thành viên.{" "}
              </p>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5 rounded-xl border border-gray-200">
            ...
            <FormInput
              ...
              register={register("min_redeem_points", {
                required:
                  "Vui lòng nhập số điểm tối thiểu khách phải có để thực hiện đổi thưởng.",
              })}
            ...
            <FormInput
              ...
              register={register("max_redeem_points", {
                required:
                  "Vui lòng nhập số điểm tối đa khách có thể dùng trong một lần đổi.",
              })}
                ...
                <div
                  ...
                  className={`pt-7 pb-2 px-5 border rounded-2xl relative shadow-sm transition-colors 
                                ${
                                  ...
                                  franchiseOptions.find(
                                    (f) =>
                                      f.value === getValues("franchise_id"),
                                  )?.isExisting
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 items-end">
                    ...
                    <FormInput
                      ...
                      isView={isView}
                      register={register(
                        `tier_rules.${index}.benefit.order_discount_percent`,
                      )}
                    ...
                    <FormInput
                      ...
                      isView={isView}
                      register={register(
                        `tier_rules.${index}.benefit.earn_multiplier`,
                      )}
