          ...
          >
                      ...
                      const matches = existingDataList.filter(
                        (item) =>
                          String(item.product_id) ===
                            String(watchedProductId) &&
                          String(item.franchise_id) ===
                            String(watchedFranchiseId || selectedFranchiseId),
                      );
            ...
            <div className="col-span-2 p-4 bg-blue-50/50 rounded-xl border border-blue-100 flex gap-3 items-start">
              ...
              <p className="text-[13px] text-blue-700 leading-relaxed">
                Lưu ý: Hệ thống cho phép tự nhập <strong>Kích cỡ</strong>. Vui
                lòng thống nhất cách đặt tên (ví dụ cùng là "L" thay vì "Large")
                để dễ dàng quản lý kho.
              </p>
            </div>
          </div>
        </div>
